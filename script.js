...
function openGmail() {
  const email = "iampiyush110@gmail.com";
...
function downloadCV() {
  ...
  link.href = "Piyush Yadav RESUME.pdf"; // Path to your resume file
  link.download = "Piyush Yadav Resume"; // Name for the downloaded file
